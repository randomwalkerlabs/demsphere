...
func main() {
	...
	// Choose planet
	planet := "earth" // Change this according to user input

	// Retrieve variables for the chosen planet
	variables, ok := celestialVariables[planet]
	if !ok {
		log.Fatalf("planet %s not found in celestialVariables", planet)
	}
	// Make outer shell
